...
class Xception(nn.Module):
    ...
    def __init__(self, num_classes=1000, replace_stride_with_dilation=None):
        ...
        self.block1 = self._make_block(64, 128, 2, 2, start_with_relu=False,
                                       # 1 / 4
                                       grow_first=True, dilate=replace_stride_with_dilation[0])
        self.block2 = self._make_block(128, 256, 2, 2, start_with_relu=True,
                                       # 1 / 8
                                       grow_first=True, dilate=replace_stride_with_dilation[1])
        self.block3 = self._make_block(256, 728, 2, 2, start_with_relu=True,
                                       # 1 / 16
                                       grow_first=True, dilate=replace_stride_with_dilation[2])
        ...
        self.block12 = self._make_block(728, 1024, 2, 2, start_with_relu=True,
                                        # 1 / 32
                                        grow_first=False, dilate=replace_stride_with_dilation[3])

        self.conv3 = SeparableConv2d(
            1024, 1536, 3, 1, 1, dilation=self.dilation)
        self.bn3 = nn.BatchNorm2d(1536)
        self.relu3 = nn.ReLU(inplace=True)

        # do relu here
        self.conv4 = SeparableConv2d(
            1536, 2048, 3, 1, 1, dilation=self.dilation)
